...
for element in df['body_mass_g']:
    element = int(element)
suma = sum(df['body_mass_g'][df['sex'] == 'MALE'])
ilosc = len(df['body_mass_g'][df['sex'] == 'MALE'])
print(f'MALE: {suma/ilosc}')
suma = sum(df['body_mass_g'][df['sex'] == 'FEMALE'])
ilosc = len(df['body_mass_g'][df['sex'] == 'FEMALE'])
print(f'FEMALE: {suma/ilosc}')
